...
```html
<a href="#" onclick="parent.postMessage({action: 'window', key: 'key', x: 20, y: 20, width: 640, height: 480, classList: ['myCustomClass']}, '*')">click me</a>
```

You can also call a Window constructor directly, but naturally only from a file you have loaded `win[.min].js`:

```html
<a href="#" onclick="new Window('key', {x: 20, y: 20, width: 640, height: 480, classList: ['myCustomClass']})">click me</a>
```
